...
--------------------------------------------*/
    ...
    if (animation) {
      ...
      var text = $('#home .typer-title'),
          textOne = "I'm an aspiring Software Developer",
          textTwo = "I have a knack for solving problems",
          textThree = "Let's take on challenging tasks together";
...
-------------------------------------------------------------------------*/
    ...
    $(form).on('submit',function(event) {
      ...
      $.ajax({
          type: 'POST',
          url: 'file:///Users/Aruvansh/Desktop/Resume/mail:contact.php',
          data: formData
